...

{
    ...
    {
      question: "Two single phase transformers A and B are operating in parallel having same impedance. But the x/r ratio of them are not equal. Then total kVA output of the output will be",  ///// Write the question inside double quotes
      answers: {
